...
async function createCollection(req, res) {
    try {
        ...
        const existing = await db_1.default.collection.findUnique({
        ...
        const collection = await db_1.default.collection.create({
            data: {
        ...
        await db_1.default.nFT.updateMany({
            where: { contractAddress: normalizedAddress },
...
async function getUserCollections(req, res) {
    try {
        ...
        const collections = await db_1.default.collection.findMany({
            where: {
                ownerAddress: userAddress.toLowerCase()
            },
            orderBy: {
...
async function getCollectionDetails(req, res) {
    try {
        ...
        const collection = await db_1.default.collection.findUnique({
            where: { contractAddress: normalizedAddress },
            include: {
                owner: true
            }
        ...
        const nfts = await db_1.default.nFT.findMany({
            where: {
