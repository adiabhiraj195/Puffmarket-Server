...
exports.getNftDetails = getNftDetails;
...
async function getNftDetails(req, res) {
    const { id } = req.params;
    try {
...
async function buyNft(req, res) {
    ...
    try {
        ...
        const sellerUser = await db_1.default.user.findFirst({
            where: {
                OR: [
                    { id: sellerId },
...
async function getNftTransactions(req, res) {
    const { id } = req.params;
    try {
        const nft = await db_1.default.nFT.findFirst({
            where: {
